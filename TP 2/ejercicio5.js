...
const paquetesGrandes = paquetesDatos.filter(paquete => paquete.tamaño > 1000);

const paquetesOrdenados = paquetesGrandes.sort((a, b) => b.prioridad - a.prioridad);

console.log(paquetesOrdenados);